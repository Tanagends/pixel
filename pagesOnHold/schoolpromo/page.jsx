...
const IconShield = () => (<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>);
...
export default function SchoolOfferPage() {
    ...
    const features = [
        "No-code blog publishing for journalism clubs",
        "Instant event & announcement management",
        "Scheduled future publishing for easy planning",
        "Seamless social media integration",
        "Limitless page customization without code",
        "Full accessibility (WCAG) compliance for inclusivity",
    ];
        ...
        <div className="bg-gray-50 pt-28">
            ...
            <section className="relative py-20 md:py-24 text-center overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative">
                    ...
                    >
                        Attract the best students, build immense community pride, and showcase your excellence with a world-class digital presence.
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <motion.button 
                            className="mt-8 bg-orange-500 text-white font-bold py-4 px-8 rounded-lg text-lg hover:bg-orange-600 transition-colors duration-300 shadow-lg shadow-orange-500/30"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
                            Claim Your 25% Founders Discount
                        </motion.button>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-24 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">A Digital Presence That Dominates</h2>
                        <p className="mt-4 max-w-2xl mx-auto text-gray-600">We don't just build websites; we build a competitive advantage for your institution.</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        <motion.div className="text-center p-8" initial={{opacity: 0, y: 50}} whileInView={{opacity: 1, y: 0}} viewport={{once: true, amount: 0.5}} transition={{duration: 0.6, delay: 0}}>
                            ...
                            <h3 className="text-xl font-bold mb-2">Prestigious First Impression</h3>
                            <p className="text-gray-600">Cutting-edge, aesthetic designs that are far above the standard, reflecting your school's true excellence.</p>
                        </motion.div>
                        <motion.div className="text-center p-8" initial={{opacity: 0, y: 50}} whileInView={{opacity: 1, y: 0}} viewport={{once: true, amount: 0.5}} transition={{duration: 0.6, delay: 0.2}}>
                            ...
                            <p className="text-gray-600">Expert SEO strategies to ensure your school appears first, reaching a wider audience and attracting new students effortlessly.</p>
                        </motion.div>
                        <motion.div className="text-center p-8" initial={{opacity: 0, y: 50}} whileInView={{opacity: 1, y: 0}} viewport={{once: true, amount: 0.5}} transition={{duration: 0.6, delay: 0.4}}>
                            ...
                            <p className="text-gray-600">Peak performance and instant load times on any device, ensuring your visitors stay engaged and impressed.</p>
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 md:py-24 bg-gray-50">
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="pr-8">
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Your Campus, Your Voice. No Code Required.</h2>
                            <p className="text-lg text-gray-600 mb-8">We empower your entire school community to publish, create, and connect. Give your journalism club the online platform it deserves.</p>
                        ...
                        <motion.div className="h-96 bg-white rounded-xl shadow-2xl p-6" initial={{scale: 0.9, opacity: 0}} whileInView={{scale: 1, opacity: 1}} viewport={{once: true}} transition={{duration: 0.8}}>
                            <div className="h-full w-full border-2 border-dashed border-gray-200 rounded-lg flex items-center justify-center">
                                <p className="text-gray-400 text-center font-medium">Visual Mockup of the<br/>Intuitive No-Code Editor</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <motion.div className="text-center lg:text-left" initial={{opacity: 0, x: -50}} whileInView={{opacity: 1, x: 0}} viewport={{once: true, amount: 0.5}} transition={{duration: 0.8}}>
                            <div className="inline-block bg-orange-500/20 text-orange-400 p-4 rounded-full mb-4"><IconShield /></div>
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">Build Trust With Every Email</h2>
                            <p className="text-gray-300 max-w-lg">Official communications carry more weight with a professional domain. We provide corporate email setup (e.g., <span className="font-mono text-orange-400">j.doe@yourhighschool.ac.zw</span>) to enhance the credibility of your staff and student recommendations.</p>
                        </motion.div>
                        <motion.div className="bg-gray-900/50 rounded-xl shadow-lg p-8" initial={{opacity: 0, scale: 0.9}} whileInView={{opacity: 1, scale: 1}} viewport={{once: true, amount: 0.5}} transition={{duration: 0.8}}>
                            ...
                            <div className="mt-4 border-t-2 border-orange-500 pt-4">
                                <p className="font-bold text-lg text-white">Jane Moyo</p>
                                <p className="text-gray-300">Head of Science Department</p>
                                <p className="text-orange-400 mt-2">j.moyo@yourhighschool.ac.zw</p>
                                <p className="text-gray-400 text-sm mt-1">+263 4 123 456</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            {/* Bespoke Solutions & Final CTA */}
            <section className="py-20 md:py-24 bg-white text-center">
                 <div className="container mx-auto px-6">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Your Long-Term Technology Partner</h2>
                    <p className="mt-4 max-w-2xl mx-auto text-gray-600 mb-8">Beyond websites, we develop bespoke software for your school, including School Management Systems, e-learning platforms, and results publishing portals.</p>
                    <motion.button 
