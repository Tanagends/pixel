...
export default function TestimonialsSection() {
    ...
    return (
        <section className="py-20 md:py-24 bg-gray-50 text-gray-800 relative overflow-hidden">
             {/* Subtle background grid texture */}
             <div 
                className="absolute inset-0 bg-grid-black/5" 
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
                ...
                <div className="relative max-w-3xl mx-auto h-56 md:h-48">
                    ...
                    <div className="absolute -top-8 left-0 text-gray-200 opacity-80 z-0">
                        <IconQuote />
                    </div>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <p className="mt-6 font-bold text-gray-900 text-lg">{testimonials[currentTestimonial].name}</p>
                            <p className="text-sm text-orange-500">{testimonials[currentTestimonial].company}</p>
                        </motion.div>
                    </AnimatePresence>
                     
                     {/* Decorative quote icon in the background */}
                     <div className="absolute -bottom-8 right-0 text-gray-200 opacity-80 z-0 transform rotate-180">
                        <IconQuote />
                    </div>
                </div>
            </div>
