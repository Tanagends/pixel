...
//================================================================//
// Data for the two promotions - UPDATED WITH MARKETING COPY
//================================================================//
const promoData = {
    education: {
        id: 'education',
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    <h2 className="text-4xl md:text-5xl font-bold text-white">
                        Exclusive Growth Packages
                    </h2>
                    <p className="mt-4 max-w-2xl mx-auto text-gray-300">
                        Tailored solutions for academic institutions and ambitious enterprises. Your success story starts here.
                    </p>
                </div>

                <div className="relative max-w-4xl mx-auto h-[520px] md:h-[450px] bg-black/30 backdrop-blur-sm border border-white/10 rounded-2xl shadow-2xl shadow-black/30">
                    {/* Background Glow */}
                    <div 
